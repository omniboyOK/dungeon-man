!(function(t, e) {
  "object" == typeof exports && "object" == typeof module
    ...
    ? (exports.rexgesturesplugin = e())
    : (t.rexgesturesplugin = e());
})(window, function() {
  return (function(t) {
    var e = {};
    function n(i) {
                ...
                states: {
                  ...
                  BEGIN: {
                    enter: function() {
                      ...
                      (s.startX = t.x),
                        (s.startY = t.y),
                        (s.startWorldX = t.worldX),
                        (s.startWorldY = t.worldY);
                    }
                  },
                  RECOGNIZED: {
                    enter: function() {
                    ...
                    exit: function() {
                      ...
                      (s.endX = t.x),
                        (s.endY = t.y),
                        (s.endWorldX = t.worldX),
                        (s.endWorldY = t.worldY),
                        s.emit("panend", s, s.gameObject, s.lastPointer);
                    }
                  }
                },
                init: function() {
            ...
            (l = [
              {
                ...
                value: function(t) {
                  return (
                    u(c(e.prototype), "resetFromJSON", this).call(this, t),
                    this.setDragThreshold(f(t, "threshold", 10)),
                    this
                  );
                }
              },
                ...
                value: function() {
                  switch (this.state) {
                    ...
                    case v:
                      ...
                      (self.x = n.x),
                        (self.y = n.y),
                        (self.worldX = n.worldX),
                        (self.worldY = n.worldY),
                        this.emit("pan", this);
                  }
                }
              },
      ...
      var i = n(61),
        ...
        u = function(t, e) {
          ...
          var r = a.x,
            ...
            u = this.rotation;
          if (Array.isArray(t))
            for (var c = t, h = 0, f = c.length; h < f; h++)
              ((t = c[h]).x += n), (t.y += i), s(t, r, o, u);
            ...
            (o = [
              {
                ...
                value: function(t) {
                  return (
                    l(p(e.prototype), "resetFromJSON", this).call(this, t),
                    this.setDragThreshold(d(t, "threshold", 0)),
                    this
                  );
                }
              },
              {
                key: "onDrag2Start",
                value: function() {
                  (this.prevAngle = g(m(this.angleBetween))),
                    (this.state = 0 === this.rotationThreshold ? P : E);
                }
              },
              {
                key: "onDrag2End",
    ...
    22: function(t, e, n) {
      ...
      var a = (function() {
        function t(e) {
          ...
          if (i)
            for (var r in i)
              (this.hasOwnProperty(r) && void 0 !== this[r]) ||
                (this[r] = i[r]);
          var s = o()(e, "eventEmitter", void 0),
            a = o()(e, "EventEmitterClass", void 0);
          this.setEventEmitter(s, a),
            (this._stateLock = !1),
        ...
        s = (function() {
          function t(e, n) {
            !(function(t, e) {
              ...
              (this._isRunning = !1),
              (this.tickingState = !1),
              this.setEventEmitter(o(n, "eventEmitter", void 0)),
              this.setTickingMode(o(n, "tickingMode", 1));
          }
          var e, n, i;
          return (
            (e = t),
      ...
      var g = (function(t) {
        function e(t, n) {
          ...
          return (
            ...
            ((i = y(this, v(e).call(this, t, n))).add = new r(t)),
            i
          );
        }
        return (
      ...
      var f = Phaser.Utils.Objects.GetValue,
        l = (function(t) {
          function e(t, n) {
            ...
            return (
              o === t && (t = void 0),
              ((i = a(this, c(e).call(this, o, n))).scene = o),
              (i.gameObject = t),
              t && t.setInteractive(f(n, "inputConfig", void 0)),
              i.resetFromJSON(n),
              i.boot(),
              i
            );
            ...
            (o = [
              {
                ...
                value: function(t) {
                  return (
                    this.setEnable(f(t, "enable", !0)),
                    void 0 === this.gameObject
                      ? (this.bounds = f(t, "bounds", void 0))
                      : (this.bounds = void 0),
                    (this.tracerState = p),
                    (this.pointer = void 0),
              ...
              },
              {
                key: "boot",
                value: function() {
                  u(c(e.prototype), "boot", this).call(this),
                    this.gameObject
                      ? this.gameObject.on(
                          "pointerdown",
                          this.onPointerDown,
              ...
              },
              {
                ...
                value: function() {
                  this.gameObject
                    ...
                    (this.lastPointer = void 0),
                    (this.movedState = !1),
                    u(c(e.prototype), "shutdown", this).call(this);
                }
              },
              {
                key: "destroy",
              ...
              },
              {
                ...
                value: function(t) {
                  return (
                    ...
                    this.enable === t
                      ? this
                      : (t || this.dragCancel(), (this.enable = t), this)
                  );
                }
              },
              {
                ...
                value: function(t, e) {
                  this.enable &&
                    void 0 === this.pointer &&
                      ...
                      (this.tracerState = y),
                      void 0 === this.gameObject &&
                        (this.isTouchingAnyObject = e.length > 0),
                      this.onDragStart());
                }
              },
              {
              ...
              },
              {
                ...
                value: function() {
                  return (
                    this.tracerState === y && this.onDragEnd(),
                    (this.pointer = void 0),
                    (this.tracerState = p),
                    this
                  );
              ...
              { key: "postUpdate", value: function(t, e) {} },
              {
                key: "startTicking",
                value: function() {
                  u(c(e.prototype), "startTicking", this).call(this),
              ...
              },
              {
                key: "stopTicking",
                value: function() {
                  u(c(e.prototype), "stopTicking", this).call(this),
                    this.scene &&
    ...
    6: function(t, e, n) {
      ...
      e.a = function(t) {
        return Object(i.a)(t)
          ? t
          : t.scene && Object(i.a)(t.scene)
          ? t.scene
          : t.parent && t.parent.scene && Object(i.a)(t.parent.scene)
          ? t.parent.scene
          : void 0;
      };
    },
      ...
      var s = Phaser.Utils.Objects.GetValue,
        ...
        h = (function() {
          function t(e, n) {
            ...
            i < 2 && e.input.addPointer(2 - i),
              (this.scene = e),
              this.setEventEmitter(s(n, "eventEmitter", void 0)),
              (this.pointers = []),
              (this.movedState = {}),
              this.resetFromJSON(n),
              this.boot();
          }
          var e, n, i;
          return (
            ...
            (n = [
              {
                ...
                value: function(t) {
                  return (
                    ...
                    (this.bounds = s(t, "bounds", void 0)),
                    (this.tracerState = l),
                    (this.pointers.length = 0),
                    Object(r.a)(this.movedState),
                    this
                  );
                }
              },
              ...
              },
              {
                ...
                value: function() {
                  return (
                    this.tracerState === y && this.onDrag2End(),
                    (this.pointers.length = 0),
                    Object(r.a)(this.movedState),
                    (this.tracerState = l),
                    this
                ...
                states: {
                  ...
                  BEGIN: {
                    enter: function() {
                      s.start(),
                        (s.tapsCount = 0),
                        s.emit("tappingstart", s, s.gameObject, s.lastPointer);
                    }
                  },
                  RECOGNIZED: {
                    enter: function() {
                      s.start(),
                        s.emit("tap", s, s.gameObject, s.lastPointer),
                        s.emit(
                          "".concat(s.tapsCount, "tap"),
                          s,
                          s.gameObject,
                          s.lastPointer
                        );
            ...
            (p = [
              {
                ...
                value: function(t) {
                  u(c(e.prototype), "resetFromJSON", this).call(this, t),
                    this.setMaxHoldTime(f(t, "time", 250)),
                    this.setTapInterval(f(t, "tapInterval", 200)),
                    this.setDragThreshold(f(t, "threshold", 9)),
                    this.setTapOffset(f(t, "tapOffset", 10));
                  var n = f(t, "taps", void 0);
                  return (
                    void 0 !== n
                      ? this.setTaps(n)
                      : (this.setMaxTaps(f(t, "maxTaps", void 0)),
                        this.setMinTaps(f(t, "minTaps", void 0))),
                    this
                  );
                }
              },
                ...
                value: function() {
                  switch (this.state) {
                    ...
                    case v:
                      ...
                      l(t.upX, t.upY, t.x, t.y) > this.tapOffset &&
                        ((this.state = d), (this.state = v));
                      break;
                    case d:
                      this.state = v;
                  }
              ...
              },
              {
                ...
                value: function(t, e) {
                  if (this.state === v) {
                    ...
                    if (n.isDown)
                      t - n.downTime > this.holdTime && (this.state = y);
                    else
                      t - n.upTime > this.tapInterval &&
                        (void 0 === this.minTaps ||
                        this.tapsCount >= this.minTaps
                          ? (this.state = d)
                          : (this.state = y));
                  }
                }
              ...
              },
              {
                ...
                value: function(t, e) {
                  return (
                    void 0 === e && (e = t),
                    this.setMinTaps(t).setMaxTaps(e),
                    this
                  );
                }
              },
            ...
            (l = [
              {
                ...
                value: function(t) {
                  return (
                    u(c(e.prototype), "resetFromJSON", this).call(this, t),
                    this.setDragThreshold(f(t, "threshold", 9)),
                    this.setMinHoldTime(f(t, "time", 251)),
                    this
                  );
                }
              },
            ...
            (l = [
              {
                ...
                value: function(t) {
                  return (
                    u(c(e.prototype), "resetFromJSON", this).call(this, t),
                    this.setDragThreshold(f(t, "threshold", 0)),
                    this
                  );
                }
              },
      ...
      var i = n(43),
        ...
        a = {
          ...
          getVelocity: function() {
            var t = this.pointer.position,
              e = this.pointer.prevPosition;
            return o(e.x, e.y, t.x, t.y) / (0.001 * this.getDt());
          },
      ...
      var d = Phaser.Utils.Objects.GetValue,
        ...
        b = (function(t) {
          function e(t, n) {
              ...
              s = {
                states: {
                  ...
                  RECOGNIZED: {
                    enter: function() {
                      o.start(),
                        o.updateDirectionStates(),
                        o.emit("swipe", o, o.gameObject, o.lastPointer);
                    },
                    exit: function() {
            ...
            return (
              i.setRecongizedStateObject(new r.a(s)),
            ...
            (o = [
              {
                ...
                value: function(t) {
                  return (
                    p(y(e.prototype), "resetFromJSON", this).call(this, t),
                    this.setDragThreshold(d(t, "threshold", 10)),
                    this.setMinDragVelocity(d(t, "velocityThreshold", 1e3)),
                    this.setDirectionMode(d(t, "dir", "8dir")),
                    this
                  );
                }
              },
